...
# Define plot
  ...
  p <- p + geom_hline(yintercept = 0.25926*0.3, linetype = "dashed", 
  ...
  ggsave(paste0("produced_data/Figure2_paper_altlloq.png"), 
    width = 18, height = 12, units = "cm")
  ggsave(paste0("produced_data/Figure2_pksim_altlloq.eps"), 
    width = 18, height = 12, units = "cm",
