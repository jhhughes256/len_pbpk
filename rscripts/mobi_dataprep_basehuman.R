...
# Read in PKSim data
  ...
  model.name <- "PKSim_withArterial_BaseHuman.xlsx"
...
# Read in simulation data and rename columns
  model.name <- "PKSimBrain_BaseHuman.xlsx"
  ...
  model.name <- "PKSimHeart_BaseHuman.xlsx"
  ...
  model.name <- "PKSimKidney_BaseHuman.xlsx"
  ...
  model.name <- "PKSimLung_BaseHuman.xlsx"
